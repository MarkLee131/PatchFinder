"""
2024.08.13
This script was deprecated and replaced by evaluate.py, since this version used LSTM for the model, which is an older version. 
"""
...
import configs
from model.load_data_deprecated import CVEDataset
...
def load_checkpoint(load_path, model):
    ...
    if load_path == '/mnt/local/Baselines_Bugs/PatchFinder/Phase-2/output/Checkpoints/best-checkpoint.ckpt':
...
def evaluate(model, testing_loader, k_values, reload_from_checkpoint=False, load_path_checkpoint=None, data_path='/mnt/local/Baselines_Bugs/PatchFinder/metrics/CR_LSTM_0830/predict_final_model.csv', rank_info_path='/mnt/local/Baselines_Bugs/PatchFinder/metrics/CR_LSTM_0830/ranks_final_model.csv'):
...
if __name__ == "__main__":
    MODEL_PATH = "/mnt/local/Baselines_Bugs/PatchFinder/metrics/CR_LSTM_0830/Checkpoints/final_model.pt"  
    RANK_OUTPUT_PATH = "/mnt/local/Baselines_Bugs/PatchFinder/metrics/CR_LSTM_0830/ranks_final_model.csv"
    ...
    # model_path = '/mnt/local/Baselines_Bugs/PatchFinder/Phase-2/output/Checkpoints/best-checkpoint.ckpt'
    ...
    recalls, avg_mrr, manual_efforts = evaluate(
        ...
        data_path=f'/mnt/local/Baselines_Bugs/PatchFinder/metrics/CR_LSTM_0830/predict_{data_path_flag}.csv',
        rank_info_path=RANK_OUTPUT_PATH
    )

    # Save metrics to CSV
    metrics_save_path = f'/mnt/local/Baselines_Bugs/PatchFinder/metrics/CR_LSTM_0830/metrics_{data_path_flag}.csv'
