...
if __name__ == "__main__":
    import os
    METRICS_DIR = '/mnt/local/Baselines_Bugs/PatchFinder/metrics/ablation_msg'
    os.makedirs(METRICS_DIR, exist_ok=True)
    
    MODEL_PATH = "/mnt/local/Baselines_Bugs/PatchFinder/model/output_ablation_msg/Checkpoints/final_model.pt"  
