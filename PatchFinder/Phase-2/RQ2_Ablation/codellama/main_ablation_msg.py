...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(name='train_ablation', project='PatchFinder_msg')
    ...
    CHECK_POINTS_PATH = "/mnt/local/Baselines_Bugs/PatchFinder/model/output_ablation_msg/Checkpoints"
