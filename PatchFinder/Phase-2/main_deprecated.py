...
ATTENTION: Deprecated model: LSTM + CodeReviewer

The model in this script: LSTM + CodeReviewer

31/08/2023: Next, We need to modify the model to replace the LSTM with CodeReviewer.

We implement the newer model in `main_new.py` and the older model in `main.py`.
'''
...
wandb_logger = WandbLogger(name='train', project='PatchFinder')
...
os.makedirs("/mnt/local/Baselines_Bugs/PatchFinder/Phase-2/output/Checkpoints", exist_ok=True)
...
checkpoint_callback = ModelCheckpoint(
    monitor='validation_loss',
    dirpath='/mnt/local/Baselines_Bugs/PatchFinder/Phase-2/output/Checkpoints',
...
trainer = Trainer(
    ...
    default_root_dir="/mnt/local/Baselines_Bugs/PatchFinder/Phase-2/output/Checkpoints",
    logger=wandb_logger,
...
model_save_path = "/mnt/local/Baselines_Bugs/PatchFinder/Phase-2/output/Checkpoints/final_model.pt"
