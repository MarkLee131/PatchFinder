...
msg_top100_dir= '/mnt/local/Baselines_Bugs/PatchSleuth/TF-IDF/results/top_100_msg'
diff_top100_dir= '/mnt/local/Baselines_Bugs/PatchSleuth/TF-IDF/results/top_100_diff'
os.makedirs(msg_top100_dir, exist_ok=True)
os.makedirs(diff_top100_dir, exist_ok=True)

source_dir = '/mnt/local/Baselines_Bugs/PatchSleuth/TF-IDF/results/msg_diff'
