...
import configs_ablation as configs
...
def evaluate_single_batch(model, batch):
    ...
    input_keys = ['input_ids_desc', 'attention_mask_desc', 'input_ids_msg', 'attention_mask_msg']
...
if __name__ == "__main__":
    import os
    METRICS_DIR = '/mnt/local/Baselines_Bugs/PatchSleuth/metrics/ablation_msg'
    os.makedirs(METRICS_DIR, exist_ok=True)
    
    MODEL_PATH = "/mnt/local/Baselines_Bugs/PatchSleuth/model/output_ablation_msg/Checkpoints/final_model.pt"  
