...
if __name__ == "__main__":
    import os
    METRICS_DIR = '/mnt/local/Baselines_Bugs/PatchSleuth/metrics/ablation_diff'
    os.makedirs(METRICS_DIR, exist_ok=True)
    
    MODEL_PATH = "/mnt/local/Baselines_Bugs/PatchSleuth/model/output_ablation_diff/Checkpoints/final_model.pt"  
    # MODEL_PATH = "/mnt/local/Baselines_Bugs/PatchSleuth/model/output_ablation_diff/Checkpoints/best-checkpoint.ckpt"
